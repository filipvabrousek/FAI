...
class Test():
    def __init__(self):
        ...
        self.L = tk.Label(text="Enter a value to encrypt")
        self.nPrimeLabel = tk.Label(textvariable=self.NPrimeValue)
        self.ePrimeLabel = tk.Label(textvariable=self.EPrimeValue)

        self.inputField = tk.Entry()
        self.decryptLabel = tk.Label(text="Decrypt value")
    ...
    def changeText(self):
        ...
        self.NPrimeValue.set(keys[2])
        self.encrypted = Encrypt(self.inputField.get(), keys[0], keys[1])
